...
class BooleanSimplificationSuite extends PlanTest with ExpressionEvalHelper with PredicateHelper {
  ...
  val testRelation = LocalRelation(Symbol("a").int, Symbol("b").int, Symbol("c").int,
    Symbol("d").string, Symbol("e").boolean, Symbol("f").boolean, Symbol("g").boolean,
    Symbol("h").boolean)
  ...
  val testNotNullableRelation = LocalRelation(Symbol("a").int.notNull, Symbol("b").int.notNull,
    Symbol("c").int.notNull, Symbol("d").string.notNull, Symbol("e").boolean.notNull,
    Symbol("f").boolean.notNull, Symbol("g").boolean.notNull, Symbol("h").boolean.notNull)
  ...
  test("a && a => a") {
    ...
    checkCondition(Literal(1) < Symbol("a") &&
      Literal(1) < Symbol("a") && Literal(1) < Symbol("a"), Literal(1) < Symbol("a"))
  }
  ...
  test("(a && b && c && ...) || (a && b && d && ...) || (a && b && e && ...) ...") {
    ...
    checkCondition((Symbol("a") < 2 && Symbol("a") > 3 && Symbol("b") > 5) || Symbol("a") < 2,
      Symbol("a") < 2)

    checkCondition(Symbol("a") < 2 || (Symbol("a") < 2 && Symbol("a") > 3 && Symbol("b") > 5),
      Symbol("a") < 2)
    ...
    val expected = Symbol("a") === Symbol("b") && (
      (Symbol("b") > 3 && Symbol("c") > 2) || (Symbol("c") < 1 && Symbol("a") === 5) ||
        (Symbol("b") < 5 && Symbol("a") > 1))
  ...
  test("(a || b || c || ...) && (a || b || d || ...) && (a || b || e || ...) ...") {
    ...
    checkCondition((Symbol("a") < 2 || Symbol("b") > 3) && (Symbol("a") < 2 || Symbol("c") > 5),
      Symbol("a") < 2 || (Symbol("b") > 3 && Symbol("c") > 5))
  ...
  test("e && (!e || f) - not nullable") {
    checkConditionInNotNullableRelation(Symbol("e") && (!Symbol("e") || Symbol("f") ),
      Symbol("e") && Symbol("f"))

    checkConditionInNotNullableRelation(Symbol("e") && (Symbol("f") || !Symbol("e") ),
      Symbol("e") && Symbol("f"))

    checkConditionInNotNullableRelation((!Symbol("e") || Symbol("f") ) && Symbol("e"),
      Symbol("f") && Symbol("e"))

    checkConditionInNotNullableRelation((Symbol("f") || !Symbol("e") ) && Symbol("e"),
      Symbol("f") && Symbol("e"))
  }
  ...
  test("a < 1 && (!(a < 1) || f) - not nullable") {
    checkConditionInNotNullableRelation(Symbol("a") < 1 && (!(Symbol("a") < 1) || Symbol("f")),
      (Symbol("a") < 1) && Symbol("f"))
    checkConditionInNotNullableRelation(Symbol("a") < 1 && (Symbol("f") || !(Symbol("a") < 1)),
      (Symbol("a") < 1) && Symbol("f"))
  ...
  test("DeMorgan's law") {
    ...
    checkCondition(!((Symbol("e") && Symbol("f")) || (Symbol("g") && Symbol("h"))),
  ...
  test("(a && b) || (a && c) => a && (b || c) when case insensitive") {
    val plan = caseInsensitiveAnalyzer.execute(
      testRelation
        .where((Symbol("a") > 2 && Symbol("b") > 3) || (Symbol("A") > 2 && Symbol("b") < 5)))
    val actual = Optimize.execute(plan)
  ...
  test("Complementation Laws") {
    ...
    checkConditionInNotNullableRelation(Symbol("e") || !Symbol("e"),
