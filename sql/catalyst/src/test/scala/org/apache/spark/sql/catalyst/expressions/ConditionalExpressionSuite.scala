...
class ConditionalExpressionSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("case when") {
    ...
    val c1 = Symbol("a").boolean.at(0)
    val c2 = Symbol("a").boolean.at(1)
    val c3 = Symbol("a").boolean.at(2)
    val c4 = Symbol("a").string.at(3)
    val c5 = Symbol("a").string.at(4)
    val c6 = Symbol("a").string.at(5)
    ...
    val c4_notNull = Symbol("a").boolean.notNull.at(3)
    val c5_notNull = Symbol("a").boolean.notNull.at(4)
    val c6_notNull = Symbol("a").boolean.notNull.at(5)
  ...
  test("case key when") {
    ...
    val c1 = Symbol("a").int.at(0)
    val c2 = Symbol("a").int.at(1)
    val c3 = Symbol("a").int.at(2)
    val c4 = Symbol("a").string.at(3)
    val c5 = Symbol("a").string.at(4)
    val c6 = Symbol("a").string.at(5)
