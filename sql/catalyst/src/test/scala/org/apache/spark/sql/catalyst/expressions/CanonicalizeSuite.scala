...
class CanonicalizeSuite extends SparkFunSuite {
  ...
  test("SPARK-32927: Bitwise operations are commutative") {
    Seq(BitwiseOr(_, _), BitwiseAnd(_, _), BitwiseXor(_, _)).foreach { f =>
      val e1 = f(Symbol("a"), f(Symbol("b"), Symbol("c")))
      val e2 = f(f(Symbol("a"), Symbol("b")), Symbol("c"))
      val e3 = f(Symbol("a"), f(Symbol("b"), Symbol("a")))
  ...
  test("SPARK-32927: Bitwise operations are commutative for non-deterministic expressions") {
    Seq(BitwiseOr(_, _), BitwiseAnd(_, _), BitwiseXor(_, _)).foreach { f =>
      val e1 = f(Symbol("a"), f(rand(42), Symbol("c")))
      val e2 = f(f(Symbol("a"), rand(42)), Symbol("c"))
      val e3 = f(Symbol("a"), f(rand(42), Symbol("a")))
  ...
  test("SPARK-32927: Bitwise operations are commutative for literal expressions") {
    Seq(BitwiseOr(_, _), BitwiseAnd(_, _), BitwiseXor(_, _)).foreach { f =>
      val e1 = f(Symbol("a"), f(42, Symbol("c")))
      val e2 = f(f(Symbol("a"), 42), Symbol("c"))
      val e3 = f(Symbol("a"), f(42, Symbol("a")))
  ...
  test("SPARK-32927: Bitwise operations are commutative in a complex case") {
    Seq(BitwiseOr(_, _), BitwiseAnd(_, _), BitwiseXor(_, _)).foreach { f1 =>
      Seq(BitwiseOr(_, _), BitwiseAnd(_, _), BitwiseXor(_, _)).foreach { f2 =>
        val e1 = f2(f1(Symbol("a"), f1(Symbol("b"), Symbol("c"))), Symbol("a"))
        val e2 = f2(f1(f1(Symbol("a"), Symbol("b")), Symbol("c")), Symbol("a"))
        val e3 = f2(f1(Symbol("a"), f1(Symbol("b"), Symbol("a"))), Symbol("a"))
