...
## Summary
  ...
  - Expressions missing examples: !,and,bigint,binary,boolean,count_min_sketch,cume_dist,date,decimal,dense_rank,double,float,input_file_block_length,input_file_block_start,input_file_name,int,lag,lead,monotonically_increasing_id,not,ntile,or,percent_rank,positive,rank,row_number,smallint,spark_partition_id,string,struct,timestamp,tinyint,version,window
