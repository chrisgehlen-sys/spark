...
class MathFunctionsSuite extends QueryTest with SharedSparkSession {
  ...
  test("shift left") {
    ...
    checkAnswer(
      df.select(
        shiftLeft(Symbol("a"), 1), shiftLeft(Symbol("b"), 1),
        shiftLeft(Symbol("c"), 1), shiftLeft(Symbol("d"), 1),
        shiftLeft(Symbol("f"), 1)),
  ...
  test("shift right") {
    ...
    checkAnswer(
      df.select(
        shiftRight(Symbol("a"), 1), shiftRight(Symbol("b"), 1),
        shiftRight(Symbol("c"), 1), shiftRight(Symbol("d"), 1),
        shiftRight(Symbol("f"), 1)),
